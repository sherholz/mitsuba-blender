                        ...
                        if 'type' in current_property_keys:
                            if current_property['type'] in ['int', 'float', 'float_vector', 'string']:
                                layout.prop(
                                    ...
                                    expand=current_property.get('expand', False),
                                    slider=current_property.get('slider', False),
                                    toggle=current_property.get('toggle', False),
                                    icon_only=current_property.get('icon_only', False),
                                    event=current_property.get('event', False),
                                    full_event=current_property.get('full_event', False),
                                    emboss=current_property.get('emboss', True),
                                )
                            elif current_property['type'] in ['enum']:
                            ...
                            elif current_property['type'] in ['bool']:
                                layout.prop(
                                    property_group,
                                    control_list_item,
                                    text=current_property['name'],
                                ...
                                layout.template_list("UI_UL_list", current_property['src_attr'],  # Use that as uid...
                                    ...
                                    rows=current_property.get('rows', 4),
                                    maxrows=current_property.get('rows', 4),
                                    type=current_property.get('list_type', 'DEFAULT'),
                                )
