...
class MITSUBA_OT_set_interior_ior_preset(bpy.types.Operator):
    bl_idname = 'mitsuba.set_interior_ior_preset'
    ...
    def execute(self, context):
        ...
        if 'node' in dir(context):
            ...
            #print("--------", ctx)
            #for mat_type in ('glass', 'roughglass', 'glossy', 'glossycoating'):
...
@MitsubaAddon.addon_register_class
class MITSUBA_OT_set_exterior_ior_preset(bpy.types.Operator):
    bl_idname = 'mitsuba.set_exterior_ior_preset'
...
def create_ior_menu(name, opname):
    ...
    for label, iors in ior_tree:
        submenu_idname = 'MITSUBA_MT_ior_%s_cat%d' % (name, len(submenus))
        submenus.append(
...
class MITSUBA_MT_ior_presets_base(bpy.types.Menu):
    def draw(self, context):
        sl = self.layout
...
@MitsubaAddon.addon_register_class
class MITSUBA_MT_interior_ior_presets(MITSUBA_MT_ior_presets_base):
    bl_label = 'Interior IOR Presets'

    submenus = create_ior_menu('interior', 'MITSUBA_OT_set_interior_ior_preset')


@MitsubaAddon.addon_register_class
class MITSUBA_MT_exterior_ior_presets(MITSUBA_MT_ior_presets_base):
    bl_label = 'Exterior IOR Presets'

    submenus = create_ior_menu('exterior', 'MITSUBA_OT_set_exterior_ior_preset')
